...
#define QT_MODEL_224
//#define QT_MODEL_224_E
//#define QT_MODEL_1188
...
#ifdef QT_MODEL_224
config_table_element t20_gripfacesuppression_config_table[] = {
	{(int16_t*)&gripfacesuppression_config.ctrl, UINT8},
	{(int16_t*)&gripfacesuppression_config.xlogrip, UINT8},
	{(int16_t*)&gripfacesuppression_config.xhigrip, UINT8},
	{(int16_t*)&gripfacesuppression_config.ylogrip, UINT8},
	{(int16_t*)&gripfacesuppression_config.yhigrip, UINT8},
};

config_table_element t22_noisesuppression_config_table[] = {
	{(int16_t*)&noise_suppression_config.ctrl, UINT8},
	{(int16_t*)&noise_suppression_config.reserved, UINT8},
	{(int16_t*)&noise_suppression_config.reserved1, UINT8},
	{(int16_t*)&noise_suppression_config.gcaful, UINT8},
	{(int16_t*)&noise_suppression_config.gcafll, UINT8},
	{(int16_t*)&noise_suppression_config.actvgcafvalid, UINT8},
	{(int16_t*)&noise_suppression_config.noisethr, UINT8},
	{(int16_t*)&noise_suppression_config.freqhopscale, UINT8},
	{(int16_t*)&noise_suppression_config.freq[0], UINT8},
	{(int16_t*)&noise_suppression_config.freq[1], UINT8},
	{(int16_t*)&noise_suppression_config.freq[2], UINT8},
	{(int16_t*)&noise_suppression_config.freq[3], UINT8},
	{(int16_t*)&noise_suppression_config.freq[4], UINT8},
};

config_table_element t24_onetouchgestureprocessor_config_table[] = {
	{(int16_t*)&onetouch_gesture_config.ctrl, UINT8},
	{(int16_t*)&onetouch_gesture_config.numgest, UINT8},
	{(int16_t*)&onetouch_gesture_config.gesten, UINT8},
	{(int16_t*)&onetouch_gesture_config.pressproc, UINT8},
	{(int16_t*)&onetouch_gesture_config.tapto, UINT8},
	{(int16_t*)&onetouch_gesture_config.flickto, UINT8},
	{(int16_t*)&onetouch_gesture_config.dragto, UINT8},
	{(int16_t*)&onetouch_gesture_config.spressto, UINT8},
	{(int16_t*)&onetouch_gesture_config.lpressto, UINT8},
	{(int16_t*)&onetouch_gesture_config.reppressto, UINT8},
	{(int16_t*)&onetouch_gesture_config.flickthr, UINT8},
	{(int16_t*)&onetouch_gesture_config.dragthr, UINT8},
	{(int16_t*)&onetouch_gesture_config.tapthr, UINT8},
	{(int16_t*)&onetouch_gesture_config.throwthr, UINT8},
};

config_table_element t28_cteconfig_config_table[] = {
	{(int16_t*)&cte_config.ctrl, UINT8},
	{(int16_t*)&cte_config.cmd, UINT8},
	{(int16_t*)&cte_config.mode, UINT8},
	{(int16_t*)&cte_config.idlegcafdepth, UINT8},
	{(int16_t*)&cte_config.actvgcafdepth, UINT8},
	{(int16_t*)&cte_config.voltage, UINT8},
};
...
config_table_element* config_table[50] = {
	...
	[20] = (config_table_element*) &t20_gripfacesuppression_config_table,
	[24] = (config_table_element*) &t24_onetouchgestureprocessor_config_table,
	[28] = (config_table_element*) &t28_cteconfig_config_table,
};
#endif
