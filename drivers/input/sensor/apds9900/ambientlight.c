...
static ssize_t sensor_readabs_store(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
	return 0;
}
#endif
...
#if AT1_BDVER_GE(AT1_WS20)  //hhs veeapp read function add 20110316 
static DEVICE_ATTR(readabs, S_IRUGO|S_IWUSR|S_IWGRP,
        sensor_readabs_show, sensor_readabs_store);
#endif
