...
#if BOARD_VER_GE(TP15) || ((MODEL_ID == MODEL_EF35L) &&  BOARD_VER_GE(TP10)) || BOARD_VER_GE(TP20)
//110421 psj
/////////////////////////////////////////
...
#define BURST_MODE_8192_BYTE_COMPRESS_INIT_OTP_TUNE_UPDATE_7 // 110621 Center Greenish 불량,  ISP 튜닝 포인트 수정한 세팅//ICPREV2_FW159_11fps_MIPI_8192_boot_0615_Nodata_I2Cfilteroff_GoodIQ_ReOTPtesting_manualflicker2nd_CAFfastertuning_AStuning_Greendot.xml
