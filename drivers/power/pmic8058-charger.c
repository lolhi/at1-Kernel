...
#ifdef FEATURE_AT1_PMIC_CHARGING
...
#ifdef CONFIG_SKY_CHARGING
#ifdef FEATURE_AT1_PMIC_CHARGING
static int pm8058_is_ci1_cable(void);
#endif
#endif
...
#ifdef CONFIG_SKY_CHARGING
#ifndef FEATURE_AT1_PMIC_CHARGING
...
static int pm8058_is_battery_present(void)
{
	...
	if (mv_reading > 0 && mv_reading < BATT_ID_OPEN_MV)
		return 1;
#else
...
#else
#define BATT_ID_MAX_MV  1300
#define BATT_ID_MIN_MV  0
#endif
static int pm8058_is_battery_id_valid(void)
{
	int batt_id_mv;
