...
static remode_3p5Pi_key_type remode_3p5Pi_key_event[] ={                        // reffer to EF18
    { REMOTE_3P5PI_KEY_NONE, 2400, 2600, SKY_HS_NONE, HS_NONE_K, FALSE},
    { REMOTE_3P5PI_KEY_01,     0,  150, SKY_HS_EAR_CLICK, HS_HEADSET_SWITCH_K, FALSE},
    { REMOTE_3P5PI_KEY_02,    450,  650, SKY_HS_EAR_JACK_VOLUME_DOWN, HS_VOL_DOWN_K, FALSE},
    { REMOTE_3P5PI_KEY_03,    200,  400, SKY_HS_EAR_JACK_VOLUME_UP, HS_VOL_UP_K, FALSE},
//	{ REMOTE_3P5PI_KEY_04,     0,   50, SKY_HS_EAR_CLICK, HS_HEADSET_SWITCH_K, FALSE},	// car kit
};
#endif
//ST sylee earjack ---
...
#else
static Earjack_current_state current_earjack_type[] ={                       
    { NONE_EARJACK_INSERTED, 2100, 2300},
    { POLAR4_EARJACK_INSERTED,1500,  2000},
    { POLAR3_EARJACK_INSERTED, 0,  40},    
};
#endif
