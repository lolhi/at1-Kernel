...
#else
#include "timpani_profile_8x60_at1.h"
#endif
#elif IS_EF35L
...
#ifndef CONFIG_SKYSND_AMP_MAX97001
#include "sky_snd_max9879.h"
#else
#include "sky_snd_ext_amp_max97001.h"  // 20120716, kyt, AT1 Audio
#endif
#endif
...
static struct adie_codec_action_unit ispkr_stereo_48KHz_osr256_actions[] =
	SPEAKER_PRI_MONO_48000_OSR_256;  // AT1 kyt:20110228, AT1 was change stereo to mono.
...
static struct snddev_icodec_data snddev_ispkr_stereo_data = {
	...
	//.channel_mode = 2,
	.channel_mode = 1,  //20120716,kyt,AT1 was change stereo to mono.
	.default_sample_rate = 48000,
#ifdef CONFIG_SKYSND_USE_EXTAMP
...
static struct adie_codec_action_unit voip_ispkr_stereo_48KHz_osr256_actions[] =
	SPEAKER_PRI_MONO_48000_OSR_256;  // AT1 kyt
	//SPEAKER_PRI_STEREO_48000_OSR_256;
...
static struct snddev_icodec_data voip_snddev_ispkr_stereo_data = {
	...
	//.channel_mode = 2,
	.channel_mode = 1,  // AT1, 20120716, kyt
	.default_sample_rate = 48000,
#ifdef CONFIG_SKYSND_USE_EXTAMP
       .pamp_on = msm_snddev_poweramp_speaker_on,
       .pamp_off = msm_snddev_poweramp_speaker_off,
...
static struct snddev_ecodec_data snddev_bt_sco_nrec_mic_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_tx_nrec",
	.copp_id = PCM_TX,
	.channel_mode = 1,
...
struct platform_device msm_bt_sco_mic_nrec_device = {
	.name = "msm_snddev_ecodec",
	.dev = { .platform_data = &snddev_bt_sco_nrec_mic_data },
};
