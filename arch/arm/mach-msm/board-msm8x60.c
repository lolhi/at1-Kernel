...
#ifdef CONFIG_MSM_HEADSET_AT1  //AT1
...
// [ 20120713, KYT, Audio
#ifndef CONFIG_SKYSND_AMP_MAX97001  // AT1
...
#err
#endif
#if AT1_BDVER_GE(AT1_WS20) 
#define BOARD_AT1_TEMP  //hhs 20110111 at1
#endif

#if defined(BOARD_AT1_TEMP)
#define LCD_BL_I2C_CONTROL
#endif

#if defined(BOARD_AT1_TEMP)  //hhs 20110125 at1
#define VEE_2_0_CONTROL
#endif
#if defined(LCD_BL_I2C_CONTROL) || defined(VEE_2_0_CONTROL)
#include <linux/i2c-gpio.h>
#endif
// P12095 110131 added
...
#ifdef CONFIG_MSM_HEADSET_AT1  //AT1
static struct msm_headset_platform_data headset_platform_data = {
    .hs_name = "8k_handset",
    .ear_det  = 125,
#if AT1_BDVER_GE(AT1_WS22) 
    .remote_det = PM8058_MPP_PM_TO_SYS(2),  // MPP3
    .ear_det_active = 1,  // 0 : low active  1: high active
#else
    .remote_det = 123,
    .ear_det_active = 0,  // 0 : low active  1: high active
#endif
    .remote_det_active = 0, // 0: low active 1: high active
    .remote_is_int =0,  // disable interrupt
    .curr_state = 0
};
...
static struct platform_device headset_device = {
    ...
    .id     = -1,
    .dev    = {
        .platform_data = &headset_platform_data,
    },
};
#endif
...
static struct i2c_gpio_platform_data gpio_i2c_20th_data = {
	.scl_pin = VEE_SCL,
	.sda_pin = VEE_SDA,
	.udelay = 2,	/* 250 KHz */
};

struct platform_device gpio_i2c_20th_device = {
	.name = "i2c-gpio",
	.id = 20,
	.dev = {
		.platform_data = &gpio_i2c_20th_data,
	}
};

static struct i2c_board_info gpio_i2c_20th_boardinfo[] __initdata = {
	{
		I2C_BOARD_INFO("VEE20", 0x54 >> 1),
	},
};
#endif
...
#ifdef CONFIG_NFC_PANTECH_I2C_GSBI_PARALLEL  // P50179 AT1 dual i2c(nfc/audio)
#if defined(CONFIG_PN544)
...
#endif
#endif /* CONFIG_NFC_PANTECH_I2C_GSBI_PARALLEL */
...
static struct i2c_gpio_platform_data qt602240_i2c_data = {
        .scl_pin = GPIO_PIN_TOUCH_SCL,
        .sda_pin = GPIO_PIN_TOUCH_SDA,
        .udelay = 2,    /* 250 KHz */
};

static struct i2c_board_info qt602240_i2c_boardinfo[] ={
  {  
	I2C_BOARD_INFO("qt602240-i2c", 0x4A),
	.platform_data = &qt602240_i2c_data,
  },
};
#endif
...
#ifndef CONFIG_NFC_PANTECH_I2C_GSBI_PARALLEL  // P50179 AT1 dual i2c(nfc/audio)
#if defined(CONFIG_PN544)
static struct pn544_i2c_platform_data pn544 = {
	.irq_gpio = NFC_WAKEUP_GPIO,
	.ven_gpio = NFC_ENABLE_GPIO,
...
#if defined(F_SKYCAM_S5K6AAFX13) || defined(F_SKYCAM_MT9V113)  //hhs 20110211 mt9v113 camera add
...
#endif
#if !defined(F_SKYCAM_MT9V113) && !defined(F_SKYCAM_ICP_HD)//#if !defined(F_SKYCAM_S5K6AAFX13) && !defined(F_SKYCAM_ICP_HD) hhs 20110219 mt9v113 camera add
static struct msm_camera_sensor_strobe_flash_data strobe_flash_xenon = {
...
#ifdef F_SKYCAM_MT9V113  //hhs 20110211 mt9v113 camera add
...
#endif	
#ifdef F_SKYCAM_MT9V113  //hhs 20110211 mt9v113 camera add slave_addr check
	{
		I2C_BOARD_INFO("mt9v113", 0x78>>1), //0x7A>>1
	},
	#endif
	#ifdef CONFIG_IMX074
	{
...
#ifndef CONFIG_NFC_PANTECH_I2C_GSBI_PARALLEL
#if defined(CONFIG_PN544)
...
static struct rpm_regulator_init_data rpm_regulator_init_data[] = {
...
#ifndef MODEL_SKY 
#ifdef CONFIG_TOUCHSCREEN_QT602240
	RPM_LDO(PM8058_L11, 0, 1, 0, 1900000, 1900000, LDO150HMIN), //AT1
#else
...
#elif defined(F_SKYCAM_MT9V113)  //hhs 20110211 mt9v113 camera add
    ...
    #if defined(BOARD_AT1_TEMP)
	RPM_LDO(PM8058_L24, 1, 1, 0, 1300000, 1300000, LDO150HMIN),
    #else
...
#if defined(BOARD_AT1_TEMP) //hhs 20120712
...
static void display_common_power(int on)
{
	int rc;
	static struct regulator *display_reg;
	#if 0//AT1_BDVER_G(AT1_WS22)  //hhs 20110405 lcd ldo modify
    static struct regulator *display_reg1;
    #endif

	if (on) 
	{
	    #if 0//AT1_BDVER_G(AT1_WS22)  //hhs 20110405 lcd ldo modify
		_GET_REGULATOR(display_reg1, "8058_lvs0");
		if (!display_reg1)
		    return;
	    rc = regulator_enable(display_reg1);
		if (rc)
		  goto out;
		printk(KERN_ERR "%s: PM8058_LVS0 1.8v enable\n", __func__);
	    usleep(1);
		#endif
	...
	else
	{
		...
		if (!display_reg1)
		    return;
		rc = regulator_disable(display_reg1);
		if (rc)
		{
		    printk(KERN_ERR "%s: 8058_LVS0 1.8v disable fail\n", __func__);
			goto out;
		}
		regulator_put(display_reg1);
		printk(KERN_ERR "%s: 8058_LVS0 1.8v disable\n", __func__);
	    usleep(1);
        #endif
	    _GET_REGULATOR(display_reg, "8058_l12");
		if (!display_reg)
		...
		rc = regulator_force_disable(display_reg);
		if (rc)
		{
		    printk(KERN_ERR "%s: 8058_l12 3.0v disable fail\n", __func__);
			goto out;
		}
		//regulator_put(display_reg);
		printk(KERN_ERR "%s: 8058_l12 3.0v disable\n", __func__);
        #if defined(BOARD_AT1_TEMP)
	    gpio_tlmm_config(GPIO_CFG(31, 0,GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),GPIO_CFG_ENABLE);
		gpio_set_value(31,0);
		gpio_tlmm_config(GPIO_CFG(146, 0,GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),GPIO_CFG_ENABLE);
		gpio_set_value(146, 0);  //VEE_VLP
        #endif
	}
	#endif
	display_reg = NULL;
...
static void lcdc_samsung_panel_power(int on)
{
	...
	//hhs mipi_dsi_panel_power(0); /* set 8058_ldo0 to LPM */
}
#endif  //CONFIG_FB_MSM_LCDC_SAMSUNG_WSVGA_PANEL
...
#if defined(BOARD_AT1_TEMP) //hhs 20110127 test CONFIG_FB_MSM_LCDC_SAMSUNG_WSVGA_PANEL
...
#ifndef CONFIG_NFC_PANTECH_I2C_GSBI_PARALLEL //p50253@yjs.log
	else
...
#endif /* TDMB_USES_I2C_CONTROL_WS20 */
#ifdef LCD_BL_I2C_CONTROL
    i2c_register_board_info(19, i2c_led_devices,ARRAY_SIZE(i2c_led_devices));
#endif /* LCD_BL_I2C_CONTROL */
#ifdef VEE_2_0_CONTROL
	i2c_register_board_info(20, gpio_i2c_20th_boardinfo,ARRAY_SIZE(gpio_i2c_20th_boardinfo));
#endif
